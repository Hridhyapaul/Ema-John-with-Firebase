        ...
        <div className='form-container'>
            ...
            <form onSubmit={handleSignUp}>
                ...
                <div className="form-control">
                    ...
                    <input type={show? "text" : "password"} name="confirm" id="confirm-password" placeholder="Password" required />
                    <p className='show-password' onClick={() => setShow(!show)}>
                        {
                            show ? <span>Hide password</span> : <span>Show password</span>
                        }
            ...
            <p className='isAccount'>Already have an account? <Link className='login' to="/login">Login</Link></p>
            {
